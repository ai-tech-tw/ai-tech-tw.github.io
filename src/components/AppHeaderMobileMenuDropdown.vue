<template>
  <div class="relative">
    ...
    <div
      ...
      <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden" v-show="isDropdownOpened">
        <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
          <app-header-mobile-menu-dropdown-item :name="child.name" :description="child.description" :icon="child.icon"
